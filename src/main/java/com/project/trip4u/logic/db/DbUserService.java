...
public class DbUserService implements UserService{
	...
	public UserBoundary updateUser(String userEmail, UserBoundary update) {
		...
		if (update.getRole() != null) {
			if(update.getRole().equals(UserRole.TOURIST) || update.getRole().equals(UserRole.BUSSINESS_MANAGER) || update.getRole().equals(UserRole.ADMIN)) {
				dirtyFlag = true;
	...
	public List<UserBoundary> getAllUsers(String adminEmail) {
		...
		return StreamSupport
				...
				.findAll()
				.spliterator(),false) 
				.map(this.userEntityConverter::fromEntity)
